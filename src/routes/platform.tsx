...
const TABS = ["research", "sourcing", "diligence"] as const;
...
export const Route = createFileRoute("/platform")({
  ...
  loader: async () => {
    const [radar, content, theses, thesisMatches] = await Promise.all([
    ...
    return { radar, content, sourcing, theses, thesisMatches };
  },
      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Thematic research, deal sourcing, and diligence — AI output is generated on demand and
            saved to the workbook. Portfolio KPIs now live on each company in the Portfolio tab.
          </p>
        </div>
        <Button
          variant="outline"
